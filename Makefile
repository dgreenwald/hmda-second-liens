...
.PHONY: install test data audit county-values county-value-coverage benchmark-data benchmark-estimators train train-logistic validate classify figures all clean
