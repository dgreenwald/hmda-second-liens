#!/usr/bin/env python3
"""Run Step 6 diagnostics for known-source-prior mixture probabilities."""
...
from hmda_seconds import calibration, config, mixture_calibration
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--bins", type=int, default=calibration.DEFAULT_N_BINS)
    return parser.parse_args()


def main() -> None:
    args = parse_args()
    results = mixture_calibration.run_mixture_calibration_diagnostics(
    ...
    print("Reverse mixture-calibration summary")
    print(results["reverse_summary"].to_string(index=False))
    print("Forward mixture-calibration summary")
