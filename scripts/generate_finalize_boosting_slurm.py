#!/usr/bin/env python3
"""Generate or submit the unrestricted boosting final-refit Slurm job."""
...
from hmda_seconds.boosting_selection_cluster import write_finalize_slurm
...
def main() -> None:
    ...
    destination = args.destination or (
        config.OUTPUT_DIR / "slurm" / "boosting" / "final"
    )
